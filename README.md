...
* There are four players who take turns in the following order:
  ...
  * Charlotte
  * Sweedal
- [x] Each player starts with $16
- [x] Everybody starts on GO
- [x] You get $1 when you pass GO (this excludes your starting move)
- [x] If you land on a property, you must buy it
- [x] If you land on an owned property, you must pay rent to the owner
- [x] If the same owner owns all property of the same colour, the rent is doubled
- [x] Once someone is bankrupt, whoever has the most money remaining is the winner
- There are no chance cards, jail or stations
- [x] The board wraps around (i.e. you get to the last space, the next space is the first space)
